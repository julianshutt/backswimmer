...
![mosquito_larva](enemies/images/mosquito_larva.svg)
...
![planarian_spitter](enemies/images/planarian_spitter.svg)
...
![daphnid_charger](enemies/images/daphnid_charger.svg)
...
![hydra_pod](enemies/images/hydra_pod.svg)
...
![waterscorpion_tank](enemies/images/waterscorpion_tank.svg)
...
![daphnia flock](enemies/images/daphnia_flock.svg)
...
**Patrol fish** and **rivals** can deal collisions / race pressure; see `tracks/lily_loop.yaml` for a fuller obstacle mix. They are **not** defined in `predators` and are not covered by the images above.
